...
namespace Project.DAL.Repositories.Concretes
{
    public class FoodRepository : BaseRepository<Food>, IFoodRepository
    {
        ...
        {
            return _context.Set<Food>().Where(x => x.DataStatus != ENTITIES.Enums.DataStatus.Deleted && x.Category_of_FoodID == Category_of_Food_id).Include(x=> x.Category_of_Food).AsQueryable(); ;
        }
